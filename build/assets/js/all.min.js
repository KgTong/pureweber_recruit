...
var PageTransitions=function(){function n(){m.each(function(){var n=$(this);n.data("originalClassList",n.attr("class"))}),m.eq(g).addClass("pt-page-current"),document.addEventListener("touchstart",function(n){s=n.touches[0].pageX,c=n.touches[0].pageY},!1),document.addEventListener("touchmove",function(n){n.preventDefault()},!1),document.addEventListener("touchend",a,!1)}function a(n){if(v)return!1;u=n.changedTouches[0].pageX,d=n.changedTouches[0].pageY;var a=e(s,c,u,d);switch(a){case 0:return;case 1:i(a);break;case 2:i(a)}}function t(n,a){return 180*Math.atan2(a,n)/Math.PI}function e(n,a,e,i){var o=i-a,r=e-n,s=0;if(Math.abs(r)<2&&Math.abs(o)<2)return s;var c=t(r,o);return c>=45&&135>c?s=1:c>-135&&-45>=c&&(s=2),s}function i(n){if(v)return!1;var a=m.eq(g);if(1===n){if(!(g>0))return;--g}else if(2===n){if(!(f-1>g))return;++g}v=!0;var t=m.eq(g).addClass("pt-page-current"),e="",i="";switch(n){case 1:e="pt-page-moveToBottom pt-page-ontop",i="pt-page-scaleUp";break;case 2:e="pt-page-moveToTop pt-page-ontop",i="pt-page-scaleUp"}a.addClass(e).on(animEndEventName,function(){a.off(animEndEventName),h=!0,l&&o(a,t)}),t.addClass(i).on(animEndEventName,function(){t.off(animEndEventName),l=!0,h&&o(a,t)}),support||o(a,t)}function o(n,a){h=!1,l=!1,r(n,a),v=!1}function r(n,a){n.attr("class",n.data("originalClassList")),a.attr("class",a.data("originalClassList")+" pt-page-current")}var s,c,u,d,p=$("#pt-main"),m=p.children("div.pt-page"),f=m.length,g=0,v=!1,h=!1,l=!1,E={WebkitAnimation:"webkitAnimationEnd",OAnimation:"oAnimationEnd",msAnimation:"MSAnimationEnd",animation:"animationend"};return animEndEventName=E[Modernizr.prefixed("animation")],support=Modernizr.cssanimations,n(),{init:n}}();